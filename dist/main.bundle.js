...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n\r\nconst { renderTasks } = __webpack_require__(/*! ./modules/ux.js */ \"./src/modules/ux.js\");\r\n\r\nwindow.addEventListener('DOMContentLoaded', () => {\r\n  renderTasks();\r\n});\r\n\n\n//# sourceURL=webpack://todo-list/./src/index.js?");
...
eval("const { markupAllTasks } = __webpack_require__(/*! ./functions.js */ \"./src/modules/functions.js\");\r\nconst { addTask } = __webpack_require__(/*! ./functions.js */ \"./src/modules/functions.js\");\r\nconst { removeTask } = __webpack_require__(/*! ./functions.js */ \"./src/modules/functions.js\");\r\nconst { updateTask } = __webpack_require__(/*! ./functions.js */ \"./src/modules/functions.js\");\r\nconst { updateIds } = __webpack_require__(/*! ./functions.js */ \"./src/modules/functions.js\");\r\n\r\nconst renderTasks = () => {\r\n  const tasksContainer = document.querySelector('.todo-placeholder');\r\n  updateIds();\r\n  tasksContainer.innerHTML = markupAllTasks();\r\n  const page = document.querySelector('body');\r\n  page.replaceWith(page.cloneNode(true));\r\n  addEventListeners();\r\n}\r\n\r\nconst addEventListeners = () => {\r\n  const addTaskForm = document.querySelector('form');\r\n  addTaskForm.addEventListener('submit', (e) => {\r\n    e.preventDefault();\r\n    addTask();\r\n    renderTasks();\r\n  });\r\n\r\n  const removeTaskBtn = document.querySelectorAll('.remove');\r\n  removeTaskBtn.forEach((button) => {\r\n    button.addEventListener('click', (e) => {\r\n      removeTask(e);\r\n      renderTasks();\r\n    });\r\n  });\r\n\r\n  const updateTaskInp = Array.from(document.querySelectorAll('.task-list .task-name'));\r\n  updateTaskInp.forEach((input) => {\r\n    input.addEventListener('input', (e) => {\r\n      updateTask(e);\r\n    });\r\n  });\r\n}\r\n\r\nmodule.exports = { \r\n  renderTasks,\r\n  addEventListeners\r\n}\n\n//# sourceURL=webpack://todo-list/./src/modules/ux.js?");
